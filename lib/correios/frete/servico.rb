  ...
  module Frete
    class Servico
      ...
      AVAILABLE_SERVICES = {
        ...
        "04669" => { :type => :pac_com_contrato,            :name => "PAC",            :description => "PAC com contrato"                  },
        "04596" => { :type => :pac_com_contrato_2,          :name => "PAC",            :description => "PAC com contrato ENC 2.0"                  },
        "03085" => { :type => :pac_com_contrato_3,          :name => "PAC",            :description => "PAC com contrato"                  },
        "03298" => { :type => :pac_com_contrato_4,          :name => "PAC",            :description => "PAC com contrato"                  },
        ...
        "04162" => { :type => :sedex_com_contrato_1,        :name => "SEDEX",          :description => "SEDEX com contrato"                },
        ...
        "04553" => { :type => :sedex_com_contrato_6,        :name => "SEDEX",          :description => "SEDEX com contrato ENC 2.0"                },
        "03050" => { :type => :sedex_com_contrato_7,        :name => "SEDEX",          :description => "SEDEX com contrato"                },
        "40096" => { :type => :sedex_com_contrato_8,        :name => "SEDEX",          :description => "SEDEX com contrato"                },
        "03220" => { :type => :sedex_com_contrato_9,        :name => "SEDEX",          :description => "SEDEX com contrato"                },
