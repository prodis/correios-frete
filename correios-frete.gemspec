...
Gem::Specification.new do |s|
  ...
  s.date = %q{2011-08-14}
  s.description = %q{Calculo de frete utilizando o Web Service dos Correios (http://www.correios.com.br/webservices). Servicos de frete suportados sao PAC, SEDEX, SEDEX 10, SEDEX Hoje e e-SEDEX (necessario informar codigo de empresa e senha).}
  ...
  s.summary = %q{Calculo de frete dos Correios.}
